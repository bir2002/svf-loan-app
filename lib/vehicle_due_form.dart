...
class _VehicleDueFormState extends State<VehicleDueForm> {
  ...
  Future<void> _fetchVehicleLoans() async {
    ...
    if (response.statusCode == 200) {
      ...
      print("Failed to load vehicle loans: ${response.body}");
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to load vehicle loans. Please try again.')),
      );
    }
  }
  ...
  void _onLoanIdChanged(String? loanId) {
    ...
    final selectedLoan = vehicleLoans.firstWhere((loan) => loan['loan_id'].toString() == loanId);
  ...
  Future<void> _submitVehicleDuePayment() async {
          ...
          child: ListView(
            children: <Widget>[
              DropdownButtonFormField<String>(
                ...
                items: vehicleLoans.map<DropdownMenuItem<String>>((loan) {
              ...
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: _submitVehicleDuePayment,
